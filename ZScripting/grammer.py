...
MNEMONIC.2: /\\b(LDI|CONTEXT|RCONTEXT|ALLSYNC|BOOT_REMOTE|RBOOT|OUT|IN|HALT|JMP|INC|DEC|STO|STX|LDX|LDM|LD|MUL|JOIN|CLOSE|AUTOCLOSE|TSTE|FAIL|SUCCES|SYNC|ADD|SUB|MOD|TSTG|XOR|JMPT|JMPF|TSTZ|IOSYNC|SM32_RND|SHIFTR|SHIFTL|ADDI|SUBI|MULI|DIV|DIVI|TST)\\b/
