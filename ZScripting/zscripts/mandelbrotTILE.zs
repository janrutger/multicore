MAP {
    ...
    SHARED tile_x_glob 1       ; Globale X-offset van de huidige tegel in RAM
    SHARED tile_y_glob 1       ; Globale Y-offset van de huidige tegel in RAM
    SHARED grid 12             ; Beproefde tegelbuffer: EXACT 12 woorden (3x4)
