MAP {
    ...
    SHARED grid_current 400    ; Huidige temperatuur-raster (20x20)
    SHARED grid_next 400       ; Buffer voor de berekende volgende stap
    SHARED draw_ptr 1          ; Pointer voor de interleaved display-renderer (0 t/m 400)

    SHARED itterations 1
